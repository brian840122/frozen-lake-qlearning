...
class QNetwork(nn.Module):
    ...
    def __init__(self, state_space, action_space):
        ...
        #(O) self.l1 = nn.Linear(in_features=self.state_space, out_features=self.hidden_size)
        #(O) self.l2 = nn.Linear(in_features=self.hidden_size, out_features=action_space)
